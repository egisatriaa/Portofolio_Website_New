...
const SkillCard = ({ icon:Icon, name}: Props) => {
  return (
    <div className='group relative bg-gray-300 dark:bg-blue-950 shadow-md rounded-xl p-4 flex flex-col items-center gap-3 cursor-pointer hover:scale-105 transition-all duration-300'>
