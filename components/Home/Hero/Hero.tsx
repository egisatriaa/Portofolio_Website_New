...
const Hero = () => {
    return (
        <div id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[radial-gradient(circle_700px_at_50%_30%,#e8f3f6_0%,#d6e6ec_40%,#c3d7df_100%)] dark:bg-[radial-gradient(circle_800px_at_50%_30%,#2c5364_0%,#203a43_45%,#0f2027_100%)]">
            {/* content */}
            <div className="relative z-10 text-center">
                {/* subtitle */}
                <div className="sm:mb-6 mt-16 md:mt-0">
                    <motion.div 
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: false, amount: 0.2 }}
                        transition={{ duration: 0.5 }}
                        className="snake-border inline-block mb-8 rounded-lg"
                    >
                    ...
                    <motion.p 
                        ...
                        className="text-lg  text-muted-foreground dark:text-gray-200 max-w-2xl mx-auto mb-10 px-4 md:px-0"
                    >
                        I'm a{' '}
                        <span className="text-yellow-500 dark:text-yellow-200">
                            Web Developer
                    ...
                    >
                        ...
                        <a href="https://drive.google.com/file/d/1Faa8Ld3_B9O5hXQ3LxHYpxG9L2lvW_TM/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                            <Button
                                size={'lg'}
